...
const DashboardDetail = ({ open, setOpen }) => {
  ...
  const list = useMemo(() => [
    { title: 'แจ้งปัญหาระบบ IT', icon: <DvrTwoToneIcon />, link: 'Ticket', component: <Ticket {...{ setSelectMenu, link: 'Ticket' }} /> },
    { title: 'Asset', icon: <DeviceHubTwoToneIcon />, link: 'Asset', component: <Asset {...{ setSelectMenu, link: 'Asset' }} /> },
    { title: 'Memo', icon: <FilePresentIcon />, link: 'Memo', component: <Memo {...{ setSelectMenu, link: 'Memo' }} /> },
    { title: 'Remind', icon: <AccessAlarmsTwoToneIcon />, link: 'Remind', component: <Remind {...{ setSelectMenu, link: 'Remind' }} /> }
  ], [])
